        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-4 p-b-30 ">
                ...
                <div class="block1 wrap-pic-w banner-wrapper-image">
                    ...
                    <a href="{{route('catalog.category', ['slug' => $category->slug])}}" class="block1-txt ab-t-l s-full flex-col-l-sb trans-03 respon3">
                        ...
                        <div class="block1-txt-child2 m-l-15 m-b-10  trans-05">
