...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('backend/assets/styles/color/orange.min.css')}}">
...
<body>
	...
	<!--
        ...
        <script src="{{asset('backend/web/js/converter/slug-converter.js')}}"></script>
        <script src="{{asset('backend/web/js/converter/price-converter.js')}}"></script>
        <script src="{{asset('backend/web/js/main.js')}}"></script>
