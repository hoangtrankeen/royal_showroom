    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <div class="box-content card white">
                <h4 class="box-title">Tạo trạng thái đơn hàng</h4>
                <!-- /.box-title -->

                <div class="card-content">
                    <form class="form-horizontal" action="{{route('order-status.store')}}" id="order-status" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
